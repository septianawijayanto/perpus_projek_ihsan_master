...
@section('konten')
                                            ...
                                            <td>
                                                @if ($dt->status == 'proses')
                                                    <button data-toggle="modal"
                                                        data-target="#modalsetujui-{{ $dt->id }}"
                                                        class="btn btn-primary btn-xs "
                                                        class="fa fa-check">Setujui</button>

                                                    <!-- <a href="{{ url('admin/transaksi/setujui/' . $dt->id) }}" class="btn btn-primary btn-xs ">Setujui</a> -->
                                                    <a href="{{ url('admin/transaksi/tolak/' . $dt->id) }}"
                ...
                <div class="modal-body">
                    <form action="{{ url('admin/transaksi/create') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('anggota_id') ? 'has-error' : '' }}">
                            ...
                            <select name="anggota_id" class="form-control select2" style="width: 100%">
                        ...
                        <div class="form-group {{ $errors->has('tgl_kembali') ? 'has-error' : '' }}">
                            ...
                            <input name="tgl_kembali" type="date" class="form-control" id="inputkode"
                                placeholder="Input kode" value="">
    ...
    @foreach ($data as $setujui)
        <div class="modal fade" id="modalsetujui-{{ $setujui->id }}" tabindex=" -1" role="dialog"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ url('admin/transaksi/setujui/' . $setujui->id) }}" method="POST"
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-danger" data-dixsiss="modal"><i
                                        class="fa  fa-power-off"></i> Tutup</button>
                                <button type="submit" class="btn btn-primary"><i class="fa fa-save"></i> Simpan</button>
                            </div>
                        </form>
