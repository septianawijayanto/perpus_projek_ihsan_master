            ...
            <div class="modal-body">
                <form action="{{ url('admin/buku/create') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group {{$errors->has('judul') ? 'has-error' :''}}">
                        ...
                        @if($errors->has('judul'))
                        <span class="right label label-danger" class=" help-block">{{$errors->first('judul')}}</span>
                        @endif
                    </div>
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group {{$errors->has('kode_buku') ? 'has-error' :''}}">
                                ...
                                <span class="right label label-danger" class=" help-block">{{$errors->first('kode_buku')}}</span>
                                @endif
                            </div>
                            <div class="form-group {{$errors->has('isbn') ? 'has-error' :''}}">
                                ...
                                @if($errors->has('isbn'))
                                <span class="right label label-danger" class=" help-block">{{$errors->first('isbn')}}</span>
                                @endif
                            </div>
                            <div class="form-group {{$errors->has('pengarang') ? 'has-error' :''}}">
                                ...
                                <span class="right label label-danger" class=" help-block">{{$errors->first('pengarang')}}</span>
                                @endif
                            </div>
                            <div class="form-group {{$errors->has('penerbit') ? 'has-error' :''}}">
                                ...
                                <span class="right label label-danger" class=" help-block">{{$errors->first('penerbit')}}</span>
                                @endif
                            </div>
                            <div class="form-group {{$errors->has('tahun_terbit') ? 'has-error' :''}}">
                                ...
                                <span class="right label label-danger" class=" help-block">{{$errors->first('tahun_terbit')}}</span>
                                @endif
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group {{$errors->has('jml_buku') ? 'has-error' :''}}">
                                ...
                                <span class="right label label-danger" class=" help-block">{{$errors->first('jml_buku')}}</span>
                                @endif
                            </div>
                            <div class="form-group {{$errors->has('sumber') ? 'has-error' :''}}">
                                ...
                                <span class="right label label-danger" class=" help-block">{{$errors->first('sumber')}}</span>
                                @endif
                            </div>
                            <div class="form-group {{$errors->has('lokasi') ? 'has-error' :''}}">
                                ...
                                <span class="right label label-danger" class=" help-block">{{$errors->first('lokasi')}}</span>
                                @endif
                            </div>
                            <div class="form-group {{$errors->has('deskripsi') ? 'has-error' :''}}">
                                ...
                                <span class="right label label-danger" class=" help-block">{{$errors->first('deskripsi')}}</span>
                                @endif
                            </div>
                            <div class="form-group {{$errors->has('cover') ? 'has-error' :''}}">
                                ...
                                @if($errors->has('cover'))
                                <span class="right label label-danger" class=" help-block">{{$errors->first('cover')}}</span>
                                @endif
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-body">
                <form action="{{ url('buku/import') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group {{$errors->has('file_name') ? 'has-error' :''}}">
                        ...
                        <span class="right label label-danger" class=" help-block">{{$errors->first('file_name')}}</span>
                        @endif
                    </div>
